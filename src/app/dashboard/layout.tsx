...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger } from "../__components/ui/dialog";
...
export default async function Layout({
  ...
  const socials = [
    ...
    [IoMail, "elewasita@gmail.com", "mailto:elewasita@gmail.com"]
  ] as const;
